...
<body style="font-family: Arial, sans-serif; background-color: #f5f7fa; margin: 0; padding: 0;">
  ...
  <table align="center" width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 6px; overflow: hidden;">
    <!-- Logo -->
    <tr>
    ...
    <tr>
      <td align="center" style="padding: 20px 40px;">
        <h1 style="color: #333; font-size: 24px;">Thanks for signing up, [User Name]!</h1>
        <p style="color: #555; font-size: 16px;">
          Please verify your email address to get access to thousands of exclusive job listings.  
          <strong style="color:#f7b500;">Thank you!</strong>
        </p>
