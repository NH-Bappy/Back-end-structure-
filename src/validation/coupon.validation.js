...
exports.validateCoupon = async (req) => {
    try {
        ...
        return {
            /**If validation succeeds, it returns only the cleaned fields that are relevant.
            This ensures only safe, validated data is passed forward.
            Even if req.body contained extra/unknown fields, they won’t go through because you return only the allowed ones. */
            code: value.code,
